...
#ifdef YACCDEBUG
#include <stdio.h>
#define YPRINTF(...) printf(__VA_ARGS__)    // __VA_ARGS__: 可变参数列表
#else
#define YPRINTF(...)
#endif
...
{
       0,   114,   114,   115,   118,   125,   129,   160,   161,   164,
     167,   176,   180,   192,   196,   201,   206,   213,   221,   236
};
#endif
...
#line 129 "src/parser.y" /* yacc.c:1646  */
  ...
  //printf("ddddddddddddddddddebug: string: %s%c\n", $1, $2);
...
#line 241 "src/parser.y" /* yacc.c:1906  */
